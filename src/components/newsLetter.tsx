...
export default function NewsLetter() {
  return (
    <div className="flex flex-col text-center gap-20 p-28 md:p-16 sm:p-4">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-center bg-[#F5FFF6] p-4 rounded-md max-w-lg mx-auto shadow-sm ">
          ...
          />
          <button className="bg-[#27CD40] text-white px-10 py-3 sm:px-6 rounded-md hover:bg-green-600">
            Submit
          </button>
        </div>
